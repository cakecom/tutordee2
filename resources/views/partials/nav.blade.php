    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                @role('user')
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/home') }}" id="navbarDropdown">
                       โปรไฟล์
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('wallet.index')}}" id="navbarDropdown">
                        {!! trans('เติมเงิน') !!}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('customer.index')}}" id="navbarDropdown">
                        {!! trans('ลูกค้า') !!}
                    </a>
                </li>
                @endrole
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('tutor.index')}}" id="navbarDropdown" role="button" >
                        {!! trans('บริหารตัวเตอร์') !!}
                    </a>

                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('checkwallet.index')}}" id="navbarDropdown" role="button" >
                        {!! trans('ลูกค้าเติมเงิน') !!}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('check-doc.index')}}" id="navbarDropdown" role="button" >
                        ยืนยันลูกค้า
                    </a>
                </li>
                @endrole
